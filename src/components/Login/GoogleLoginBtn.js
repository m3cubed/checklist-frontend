...
// $script("https://apis.google.com/js/api.js", "google");
// $script.ready("google", () => {
...
class GoogleLoginBtn extends Component {
	...
	initAuth2() {
		app.gapiPromise.then(() => {
			gapi.load("auth2", () => {
				...
				this.attachSignin(document.getElementById("img-google"));
			});
		});
	}
	...
	state = { btnValue: "" };
	render() {
		return <Button>{this.state.btnValue}</Button>;
	}
}
